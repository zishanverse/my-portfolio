...
const Hero = () => {
    return (
        <section className="relative w-full min-h-screen flex items-center justify-center bg-transparent dark:bg-transparent pt-16 sm:pt-20">
            {/* Added overflow-x-hidden instead of overflow-hidden so the section can flow vertically but not cause horizontal scroll if badges overflow */}
            <div className="absolute inset-0 overflow-hidden pointer-events-none -z-30">
                {/* Background Decorative Glow (Main) */}
                <div className="absolute top-1/2 left-3/4 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-indigo-500/10 rounded-full blur-[120px]" />
            </div>

            <div className="container mx-auto px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center relative z-10">
                ...
                <div className="flex flex-col gap-6 z-10">
                    <div className="space-y-2">
                        ...
                        <ContainerTextFlip
                            words={["AI Engineer", "Full-Stack Dev", "RAG Pipelines", "Agentic AI"]}
                    ...
                    <p className="text-base sm:text-lg text-muted-foreground dark:text-gray-300 max-w-lg leading-relaxed">
                        AI Engineer and Full-Stack Developer specialized in building intelligent applications powered by RAG pipelines, LLM integrations, and scalable backend systems.
                    </p>
                    ...
                    <div className="flex flex-wrap gap-4 mt-4">
                        ...
                        <MovingButton
                            ...
                            className="bg-background text-foreground border-neutral-200 dark:border-slate-800 w-full sm:w-auto"
                        >
                            <Link href="/contact" className="flex items-center justify-center gap-2 w-full px-2">
                ...
                <div className="relative w-full h-80 sm:h-96 md:h-full flex items-center justify-center lg:justify-center xl:justify-end px-4 sm:px-10 lg:px-12 py-10 lg:py-0">
                    ...
                    <motion.div 
                        ...
                        whileHover={{ y: -10 }}
                        className="relative w-64 sm:w-72 md:w-80 aspect-[3/4] rounded-[2.5rem] p-3 bg-white/5 dark:bg-white/5 backdrop-blur-xl border border-white/20 shadow-2xl group"
                    >
                        ...
                        <div className="relative w-full h-full rounded-4xl overflow-hidden border border-white/10">
                            ...
                            <div className="absolute bottom-0 left-0 w-full p-6 bg-linear-to-t from-black/80 via-black/40 to-transparent">
                                ...
                                <p className="text-zinc-200 text-xs font-medium uppercase tracking-widest">AI Engineer</p>
                            </div>
                        </div>
