...
export const GraphLegend = () => {
    ...
    return (
        <div className="p-3.5 rounded-xl bg-muted border border-border space-y-2 select-none">
            ...
            <div className="text-[9px] text-muted-foreground font-mono leading-relaxed border-t border-border pt-2 mt-2">
