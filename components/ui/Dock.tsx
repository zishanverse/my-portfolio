...
export default function Dock({
    items,
    className = '',
    spring = { mass: 0.2, stiffness: 150, damping: 14 },
    magnification = 60,
    distance = 140,
    panelHeight = 64,
    dockHeight = 150,
    ...
    return (
        <motion.div style={{ height: panelHeight, scrollbarWidth: 'none' }} className="mx-2 flex max-w-full items-center justify-center">
            <motion.div
                onMouseMove={({ pageX }) => {
                    isHovered.set(1);
                    mouseX.set(pageX);
                ...
                className={`${className} absolute z-40 flex items-end w-fit gap-4 md:gap-12 pb-2 px-4`}
